...
-- IDENTICAL BIGINT ID FOREIGN KEY ARCHITECTURE:
--   products.id: BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY
--   product_images.product_id: BIGINT NOT NULL REFERENCES public.products(id) ON DELETE CASCADE
-- ============================================================================
