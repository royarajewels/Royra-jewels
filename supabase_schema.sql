...
CREATE TABLE IF NOT EXISTS public.banners (
  ...
  status TEXT DEFAULT 'published' CHECK (status IN ('draft', 'scheduled', 'published', 'expired', 'archived', 'Active', 'Draft', 'Archived')),
...
ALTER TABLE public.banners ADD COLUMN IF NOT EXISTS display_order INTEGER DEFAULT 1;
ALTER TABLE public.banners ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT TRUE;
ALTER TABLE public.banners ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'published';
